...
class TaskWindow(QWidget):
    ...
    def init_ui(self):
        ...
        title_label.setStyleSheet("font-size: 18px; font-weight: bold; color: #FFFFFF; margin: 25%;")
        ...
        text_label.setStyleSheet("font-size: 16px; color: #FFFFFF; background-color: none; margin: 3%;")
        text_label.setWordWrap(True)
        text_input_layout.addWidget(text_label, alignment=Qt.AlignmentFlag.AlignTop)
        ...
        hint_label.setStyleSheet("font-size: 16px; color: #FFFFFF; background-color: none; margin: 3%;")
        hint_label.setWordWrap(True)
        text_input_layout.addWidget(hint_label, alignment=Qt.AlignmentFlag.AlignTop)
        ...
        link_label.setStyleSheet("font-size: 16px; color: #FFFFFF; background-color: none; margin: 5%;")
        ...
        text_input_layout.setStretchFactor(text_label, 1)
        text_input_layout.setStretchFactor(hint_label, 1)
        text_input_layout.setStretchFactor(link_label, 1)
    ...
    def show_question(self):
        ...
        self.text.setText(f"{t.text}")
        self.hint.setText(f"{t.hint}")
    ...
    def check_answer(self):
        ...
        if user_answer == correct_answer:
            ...
            self.success.setText("Try again")
